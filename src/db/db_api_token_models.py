...
class APIToken(Base, BaseModel):
    ...
    def is_valid(self) -> bool:
        ...
        return (
            self.is_active == "active" and 
            not self.is_expired() and
            self._encrypted_token is not None
        )
...
class APITokenUsageLog(Base, BaseModel):
    ...
    success = Column(String(10), nullable=False, default="unknown")  # "success", "failed", "unknown"
