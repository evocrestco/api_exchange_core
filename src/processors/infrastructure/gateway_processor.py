...
class GatewayProcessor(ProcessorInterface):
    ...
    def __init__(self, routing_config: Dict[str, Any], queue_config: Optional[Dict[str, Any]] = None):
        """
    ...
    def process(self, message: Message, context: ProcessorContext) -> ProcessingResult:
        ...
        result.add_metadata("processing_time_ms", (datetime.now(UTC) - start_time).total_seconds() * 1000)
