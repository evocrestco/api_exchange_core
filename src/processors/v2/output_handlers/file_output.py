...
class FileOutputHandler(OutputHandler):
    ...
    def __init__(self, destination: str, config: Optional[Union[Dict[str, Any], FileOutputHandlerConfig]] = None):
        """
    ...
    def validate_configuration(self) -> bool:
        ...
        if self.output_format not in ["json", "jsonl", "text"]:
            self.logger.error(f"Invalid output_format: {self.output_format}. Must be 'json', 'jsonl', or 'text'")
            return False
    ...
    def _generate_file_path(self, message: "Message", result: "ProcessingResult") -> Path:
        ...
        try:
            ...
            raise OutputHandlerError(
                ...
                can_retry=False,
                error_details={"file_pattern": self.file_pattern, "available_vars": list(pattern_vars.keys())}
            )
    ...
    def handle(self, message: "Message", result: "ProcessingResult") -> OutputHandlerResult:
        ...
        def _execute_file_write():
            ...
            # Write to file
            try:
                with open(file_path, write_mode, encoding=self.encoding, buffering=self.buffer_size) as f:
                    f.write(content)
    ...
    def get_handler_info(self) -> Dict[str, Any]:
        ...
        base_info.update({
            ...
            "path_writable": os.access(self.base_path, os.W_OK) if self.base_path.exists() else None
        })
        return base_info