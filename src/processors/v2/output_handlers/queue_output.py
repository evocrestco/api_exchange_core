...
from .config import QueueOutputHandlerConfig, OutputHandlerConfigFactory
...
class QueueOutputHandler(OutputHandler):
    ...
    def __init__(self, destination: str, config: Optional[Union[Dict[str, Any], QueueOutputHandlerConfig]] = None):
        """
